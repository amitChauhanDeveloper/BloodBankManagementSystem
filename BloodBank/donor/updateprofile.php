 ...
 <form method="post">
   ...
   <table cellpadding="0" cellspacing="0" width="450px" align="center" >
    <tr><td class="lefttd"  style="vertical-align:middle"> Name </td><td><input type="text" name="t1" value="<?php echo @$name;  ?>"  required="required" pattern="[a-zA-Z _]{5,15}" title="please enter only character  between 5 to 15 for  name" /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td class="lefttd">Gender</td><td><input name="r1" type="radio" value="male"  <?php if($gender=="Female"){ echo "checked" ;}  ?>>Female<input name="r1" checked="checked" type="radio" value="female" <?php if($gender=="Male"){ echo "checked" ;}  ?> />Male</td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<div class="footer">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by Mr. Chauhan |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
